(function () {
  window.CANTO_ONE = {
    ...
    tagline: "Senza misura non c'e via",
    description:
      "Versione da palco del primo canto, ripulita dal draft e pronta per prova, teleprompter e proiezione.",
    images: [
      {
        src: "./images/IMG_5465 2.JPG",
        alt: "Doré, Dante solo nella selva",
        label: "Selva oscura",
        usage: "Apertura e vv. 1-24"
      },
      {
        src: "./images/IMG_5466 2.JPG",
        alt: "Doré, Dante e Virgilio nel bosco",
        label: "Apparizione di Virgilio",
        usage: "Da vv. 61-66 fino alla chiusura"
      }
    ],
    markdown: String.raw`# INFERNO - CANTO I
...
## vv. 58-75 - L'urto, Virgilio, la mappa
...
[Schermo: IMG_5466 2.JPG - Dore / Dante e Virgilio]
...
Virgilio mette anche un limite netto.
Fin qui io.
Poi serve un'altra guida.

La salita ha ordine.
La legge non e un dettaglio.
E la forma stessa del viaggio.
...
Il primo canto non racconta ancora l'Inferno.
